...
! ===========================================================================
        subroutine initialize_rho_3c_HARRIS
        implicit none
...
! ===========================================================================
        return
        end subroutine initialize_rho_3c_HARRIS
...
! Loop over all bondcharge distances.
              do ibcba = 1, nbc_rho
                dbcx = dfloat(ibcba - 1)*dbc/dfloat(nbc_rho - 1)
...
! The distance is measured from the bondcharge center (b=dbcx/2)
                do inaba = 1, nna_rho
                  dnax = dfloat(inaba - 1)*dna/dfloat(nna_rho - 1)
...
200     format (2x, ' Evaluating rho_3c integrals for nZ = ', i3,            &
     &              ' and nZ = ', i3, ', density on nZ = ', i3)

! End Subroutine
! ===========================================================================
        return
        end subroutine rho_3c_Harris
...
! ===========================================================================
        subroutine phiint_rho (itype, ispecies, jspecies, kspecies, ispmin, &
...
! Input
        ...
        real, intent (in) :: rna (3)           ! the integration coordinates
...
! Find coordinate x and y:
          ...
          do isorp = ispmin, ispmax
            ...
            vpot = (psiofr(r3, rmax, kspecies, isorp)**2)/(4.0*pi)
