...
! Evaluate the density at this grid point.
                  ...
                  if (ispecies .eq. 2 .and. jspecies .eq. 4)then
                    if (igrid .eq. 37)then
...
! Loop over grid
            ...
            do igrid = 1, ndd_vxc
              d = d + drr
              ! Set integration limits
              zmin = min(-rcutoff1, d - rcutoff2) !here problem arturo
              zmax = max(rcutoff1, d + rcutoff2)
...
! We calculate vxc(n1+n2). We compute only neutral atoms here.
!
! ===========================================================================
! Code written by:
! James P. Lewis
